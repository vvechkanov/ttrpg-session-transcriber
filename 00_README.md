...
Единственная внешняя зависимость — **Python 3.10–3.12 x64** в PATH. Всё остальное (venv, PyTorch, ffmpeg) устанавливается инсталлятором внутри этой папки.
...
- Diarization (акустическое разделение на спикеров) не используется — разделение идёт по отдельным аудиодорожкам Craig.
